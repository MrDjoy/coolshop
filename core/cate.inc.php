...
function getCateById($id){
    $sql="select id,cName from coolshop_cate where id={$id}";
    return fetchOne($sql);
}
...
function editCate($id){
    $arr=$_POST;
    $where = "id = {$id}";
    if(update("coolshop_cate", $arr,$where)){
 ...
 */
function getAllCate(){
    $sql="select id,cName from coolshop_cate";
    $rows=fetchAll($sql);
    return $rows;
}
