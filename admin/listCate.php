...
$pageSize=6;
$page=$_REQUEST['page']?(int)$_REQUEST['page']:1;//此处page从showPage()函数中GET过来
$rows=getItemsByPage("coolshop_cate",$page,$pageSize);
//print_r($rows);
//$rows = getAllCate();
if(!$rows){
...
<div class="details">
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                        <?php $i=1; foreach($rows as $row):?><!--$rows是二维array，他的每个$value也是数组-->
                            <tr>
...
<script type="text/javascript">
    ...
    function addCate(){
        window.location="addCate.php"; //js页面跳转
    }
